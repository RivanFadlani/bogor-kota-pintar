<x-app-layout>
    <div class="container mx-auto mt-10">
        ...
        <a href="{{ route('admin.dokumen.create') }}"
            class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Tambah Dokumen</a>
        ...
        <table class="min-w-full bg-white border border-gray-300">
            <thead>
                <tr>
                    ...
                    <th class="border-b-2 px-4 py-2">File</th>
                ...
                @foreach ($dokumen as $key => $item)
                    <tr>
                        ...
                        <td class="border-b px-4 py-2">
                            ...
                            <img src="{{ url('storage/' . $item->file) }}" alt="{{ $item->judul }}"
