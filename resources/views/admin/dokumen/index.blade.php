<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="mt-4 mb-10 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        {{-- search form start --}}
                        <form action="{{ route('admin.dokumen.index') }}" method="GET" class="flex">
                ...
                <a href="{{ route('admin.dokumen.index', ['sort_by' => 'created_at', 'direction' => 'desc']) }}"
                            ...
                            @foreach ($items as $dokumen)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        @endcan
                                        @can('delete dokumens')
                                            <button onclick="openDeleteModal('{{ $dokumen->id }}')"
    ...
    <script>
        ...
        function openDeleteModal(dokumenId) {
