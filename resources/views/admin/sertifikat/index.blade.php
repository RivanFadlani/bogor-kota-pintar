<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <h1 class="text-3xl font-bold text-gray-900">Daftar Sertifikat</h1>
                ...
                <div class="mt-4 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        <input type="text" id="tableSearch" placeholder="Cari Sertifikat..."
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200" id="sertifikatTable">
                        <thead>
                            <tr class="bg-gray-50">
                                <th
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($sertifikatAdm as $sertifikat)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <button onclick="openDeleteModal('{{ $sertifikat->id }}')"
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">
                                            Apakah Anda yakin ingin menghapus Sertifikat ini? Tindakan ini tidak dapat
                                            dibatalkan.
                                        </p>
                                    </div>
                                </div>
    ...
    <script>
        ...
        document.getElementById('tableSearch').addEventListener('keyup', function() {
            ...
            let table = document.getElementById('sertifikatTable');
        ...
        function openDeleteModal(sertifikatId) {
            const modal = document.getElementById('deleteModal');
            const form = document.getElementById('deleteForm');
            form.action = `/admin/sertifikat/${sertifikatId}`;
