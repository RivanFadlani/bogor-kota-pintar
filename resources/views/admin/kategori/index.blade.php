        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="mt-4 mb-10 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        {{-- search form start --}}
                        <form action="{{ route('admin.kategori.index') }}" method="GET" class="flex">
                ...
                <a href="{{ route('admin.kategori.index', ['sort_by' => 'created_at', 'direction' => 'desc']) }}"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($items as $kategoris)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        {{ $kategoris->kategori }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        @can('edit kategori dokumens')
                                            <a href="{{ route('admin.kategori.edit', $kategoris->id) }}"
                                        ...
                                        @endcan
                                        @can('delete kategori dokumens')
                                            <button onclick="openDeleteModal('{{ $kategoris->id }}')"
