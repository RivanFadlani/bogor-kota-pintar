<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <h1 class="text-3xl font-bold text-gray-900">Daftar Penilaian</h1>
                    @can('create penilaians')
                            ...
                            @foreach ($items as $penilaian)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        @endcan
                                        @can('delete penilaians')
                                            <button onclick="openDeleteModal('{{ $penilaian->id }}')"
    ...
    <script>
        ...
        function openDeleteModal(penilaianId) {
            ...
            form.action = `/admin/penilaian/${penilaianId}`;
