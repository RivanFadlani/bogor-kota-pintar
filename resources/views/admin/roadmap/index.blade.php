<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="mt-4 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        <input type="text" id="tableSearch" placeholder="Cari Road Map..."
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200" id="roadmapTable">
                        <thead>
                            <tr class="bg-gray-50">
                                <th
    ...
    <script>
        ...
        document.getElementById('tableSearch').addEventListener('keyup', function() {
            ...
            let table = document.getElementById('roadmapTable');
