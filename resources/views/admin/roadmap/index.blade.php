<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <h1 class="text-3xl font-bold text-gray-900">Daftar Road Map</h1>
                    @can('create road maps')
                ...
                <div class="mt-4 mb-10 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        {{-- search form start --}}
                        <form action="{{ route('admin.roadmap.index') }}" method="GET" class="flex">
                            <input type="text" name="query" value="{{ old('query', $query) }}"
                                placeholder="Cari Road Map..."
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <form method="GET" action="{{ route('admin.roadmap.index') }}"
                ...
                <a href="{{ route('admin.roadmap.index', ['sort_by' => 'created_at', 'direction' => 'desc']) }}"
                            ...
                            @foreach ($items as $roadmap)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <img src="{{ asset('uploads/roadmap/' . $roadmap->gambar) }}" alt="dokumen"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        @can('edit road maps')
                                            <a href="{{ route('admin.roadmap.edit', $roadmap->id) }}"
                                        ...
                                        @can('delete road maps')
                                            <button onclick="openDeleteModal('{{ $roadmap->id }}')"
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">
                                            Apakah Anda yakin ingin menghapus Road Map ini? Tindakan ini tidak dapat
                                            dibatalkan.
                                        </p>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function openDeleteModal(roadmapId) {
            ...
            form.action = `/admin/roadmap/${roadmapId}`;
