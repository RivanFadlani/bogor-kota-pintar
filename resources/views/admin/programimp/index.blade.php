        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <h1 class="text-3xl font-bold text-gray-900">Daftar Program</h1>
                    @can('create program implementasis')
                ...
                <div class="mt-4 mb-10 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        {{-- search form start --}}
                        <form action="{{ route('admin.programimp.index') }}" method="GET" class="flex">
                    ...
                    <div class="flex items-center">
                        <form method="GET" action="{{ route('admin.programimp.index') }}"
                ...
                <a href="{{ route('admin.programimp.index', ['sort_by' => 'created_at', 'direction' => 'desc']) }}"
                            ...
                            @foreach ($items as $program)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        @can('edit program implementasis')
                                        ...
                                        @endcan
                                        @can('delete program implementasis')
                                            <button onclick="openDeleteModal('{{ $program->id }}')"
