<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center">
                    <h1 class="text-3xl font-bold text-gray-900">Daftar Visi & Misi</h1>
                ...
                <div class="mt-4 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        {{-- search form start --}}
                        <form action="{{ route('admin.visimisi.index') }}" method="GET" class="flex">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <form method="GET" action="{{ route('admin.visimisi.index') }}"
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200" id="visimisiTable">
                        <thead>
                            <tr class="bg-gray-50">
                            ...
                            @foreach ($items as $visimisi)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <button onclick="openDeleteModal('{{ $visimisi->id }}')"
    ...
    <script>
        ...
        document.getElementById('tableSearch').addEventListener('keyup', function() {
            ...
            let table = document.getElementById('visimisiTable');
        ...
        function openDeleteModal(visimisiId) {
            const modal = document.getElementById('deleteModal');
            const form = document.getElementById('deleteForm');
            form.action = `/admin/visimisi/${visimisiId}`;
