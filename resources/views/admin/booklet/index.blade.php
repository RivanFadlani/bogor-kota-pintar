        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="mt-4 mb-10 flex justify-between items-center bg-white p-4 rounded-lg shadow-sm">
                    <div class="relative">
                        {{-- search form start --}}
                        <form action="{{ route('admin.booklet.index') }}" method="GET" class="flex">
                            <input type="text" name="query" value="{{ old('query', $query) }}"
                                placeholder="Cari Booklets..."
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="flex items-center">
                            <form method="GET" action="{{ route('admin.booklet.index') }}"
                ...
                <a href="{{ route('admin.booklet.index', ['sort_by' => 'created_at', 'direction' => 'desc']) }}"
